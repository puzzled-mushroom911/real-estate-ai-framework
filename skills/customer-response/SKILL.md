...
description: Draft a customer response matched to the agent's communication style and backed by knowledge base data. Use when asked to reply to a lead, draft a response, answer a buyer/seller question, handle an objection, or respond to a client message.
---
